...
Jedoch sind keine grundlegenden Änderungen nötigt. Der Editor, 
das Template und der Generator stellen keine Erwartungen an die Art der Datentypen oder Operationen im Abhängigkeits Graph. 
